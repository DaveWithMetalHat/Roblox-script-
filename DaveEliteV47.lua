...
-- The Toggle Button (This stays on the side)
...
-- The Main Frame (LOCKED IN MIDDLE)
local frame = Instance.new("Frame", screenGui)
frame.Size = UDim2.new(0, 260, 0, 400)
-- This AnchorPoint and Position puts it exactly in the center
frame.AnchorPoint = Vector2.new(0.5, 0.5)
frame.Position = UDim2.new(0.5, 0, 0.5, 0) 
frame.BackgroundColor3 = Color3.fromRGB(15, 15, 15)
frame.Visible = true
frame.Active = true
-- Draggable is set to false so it won't move
frame.Draggable = false 
Instance.new("UICorner", frame)

local header = Instance.new("TextLabel", frame)
header.Size = UDim2.new(1, 0, 0, 45)
header.Text = "DAVE WITH METAL HAT V47"
...
runService.RenderStepped:Connect(function()
    local char = player.Character
    if char and char:FindFirstChild("Humanoid") and not flying then char.Humanoid.WalkSpeed = masterSpeed end
...
-- BUTTONS & SLIDERS WITH UPDATED LIMITS
